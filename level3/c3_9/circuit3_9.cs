...
public class circuit3_9 : MonoBehaviour {
	...
	bool b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11a,b11b,b12a,b13,b14,b15,b16,b17,b18,b19,b20,b21,b22,b23,b24,b25,b26,b27,b28,b29,b30,
		b31,b32,b33,b34,b35,b36,b37,b38,b39,b40,b41,b42,b43,b44,b45,b46;
	
	
	#region Singleton
	public static circuit3_9 Instance;
	private void Awake() {
		Instance = this;
	}
	#endregion
	...
	void Start () {
		...
		b1=b2=b5=b6=b7=b8=b9=b10=b13=b11a=b12a=b11b=b14=b15=b16=b17=b20=b21=b22=b23=b24=b25=b26=b29=b30=
		b31=b32=b33=b34=b36=b37=b39=b40=b41=b42=b43=b46=false;
		b3=b4=b18=b19=b27=b28=b35=b38=b44=b45=true;
	}
	...
	void Update () {
		...
		common = (b1 && b2) && (b3 && b4) && (b5 && b6) && (b7 && b8) && (b10 && b9);

		 if(click_obj == obj11){
			if(obj11.transform.eulerAngles.y ==0f || obj11.transform.eulerAngles.y ==180f){b11a = true;}else{b11a = false;}
		}
		if(click_obj == obj12){
			if(obj12.transform.eulerAngles.y ==0f || obj12.transform.eulerAngles.y ==180f){b12a = true;}else{b12a = false;}
		}
		if(click_obj == obj33){
		...
		if(click_obj == obj40){
			if(obj40.transform.eulerAngles.y ==90f || obj40.transform.eulerAngles.y ==180f){b40 = true;}else{b40 = false;}
		}
		if(click_obj == obj41){
			if(obj41.transform.eulerAngles.y ==0f || obj41.transform.eulerAngles.y ==90f){b41 = true;}else{b41 = false;}
		}
		if(click_obj == obj27){
			if(obj27.transform.eulerAngles.y ==90f || obj27.transform.eulerAngles.y ==270f){b27 = true;}else{b27 = false;}
		}
		if(click_obj == obj28){
			if(obj28.transform.eulerAngles.y ==90f || obj28.transform.eulerAngles.y ==270f){b28 = true;}else{b28 = false;}
		}
		if(click_obj == obj39){
		...
		if(click_obj == obj44){
			if(obj44.transform.eulerAngles.y ==90f || obj44.transform.eulerAngles.y ==270f){b44 = true;}else{b44 = false;}
		}
		if(click_obj == obj45){
		...
		a = common && (b11a && b12a) && (b33 && b34) && (b35 && b36) && (b37 && b38) &&  (b40 && b41) && (b27 && b28) &&
			(b39 && b42) && (b43 && b44) && (b45 && b46);
		...
		if(click_obj == obj20){
			if(obj20.transform.eulerAngles.y ==0f){b20 = true;}else{b20 = false;}
		}
		if(click_obj == obj19){
			if(obj19.transform.eulerAngles.y ==270f){b19 = true;}else{b19 = false;}
		}
		if(click_obj == obj21){
		...
		if(click_obj == obj23){
			if(obj23.transform.eulerAngles.y == 0f || obj23.transform.eulerAngles.y ==270f){b23 = true;}else{b23 = false;}
		}
		if(click_obj == obj24){
			if(obj24.transform.eulerAngles.y ==180f || obj24.transform.eulerAngles.y ==270f){b24 = true;}else{b24 = false;}
		}
		if(click_obj == obj42){
			if(obj42.transform.eulerAngles.y ==90f || obj42.transform.eulerAngles.y ==270f){b42 = true;}else{b42 = false;}
		}
		...
		if(click_obj == obj11 || click_obj == obj12){
			if((obj11.transform.eulerAngles.y ==0f && obj12.transform.eulerAngles.y ==180f) ||
				(obj11.transform.eulerAngles.y ==0f && obj12.transform.eulerAngles.y ==90f) ||
				(obj11.transform.eulerAngles.y ==90f && obj12.transform.eulerAngles.y ==180f) ||
				(obj11.transform.eulerAngles.y ==90f && obj12.transform.eulerAngles.y ==90f) )
			{b11b = true;}else{b11b = false;}
		}

		b = common && (b13 && b14) &&(b15 && b16) &&(b17 && b18) &&(b19 && b20) &&(b21 && b22) &&
			(b23 && b24) &&(b25 && b26) &&(b42 && b43) &&(b45 && b44) && (!b27 && !b28) && transform && b11b;
