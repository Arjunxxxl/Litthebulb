...
public class level_loading3 : MonoBehaviour {
	...
	public void Next_level()	
	{
		switch(current_scene_name){
			case "circuit3_1" : StartCoroutine(load_level("circuit3_2"));		break;
			case "circuit3_2" : StartCoroutine(load_level("circuit3_3"));		break;
			case "circuit3_3" : StartCoroutine(load_level("circuit3_4"));		break;
			case "circuit3_4" : StartCoroutine(load_level("circuit3_5"));		break;
			case "circuit3_5" : StartCoroutine(load_level("circuit3_6"));		break;
			case "circuit3_6" : StartCoroutine(load_level("circuit3_7"));		break;
			case "circuit3_7" : StartCoroutine(load_level("circuit3_8"));		break;
			case "circuit3_8" : StartCoroutine(load_level("circuit3_9"));		break;
			case "circuit3_9" : StartCoroutine(load_level("circuit3_10"));		break;
			case "circuit3_10" : StartCoroutine(load_level("circuit3_1"));		break;
		}
	}
